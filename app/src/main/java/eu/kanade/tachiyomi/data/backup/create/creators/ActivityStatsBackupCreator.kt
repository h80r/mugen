...
class ActivityStatsBackupCreator(
    private val activityDatabase: ActivityDatabase = Injekt.get(),
    ...
    /**
     * Backup activity and statistics data including:
    ...
    suspend operator fun invoke(
        ...
        return ActivityStatsBackupData(
    ...
    private suspend fun backupActivityLog(): List<BackupDayActivity> {
        return try {
            ...
            val records = activityDatabase.activityLogQueries
...
/**
 * Container for activity and statistics backup data
 */
data class ActivityStatsBackupData(
