...
object GreetingProvider {
    ...
    private val generalGreetings = listOf(
        ...
        candidate("manga_tunnel_syndrome", AYMR.strings.aurora_greeting_manga_tunnel_syndrome),
        candidate("manga_translators", AYMR.strings.aurora_greeting_manga_translators),
        candidate("manga_double_spread", AYMR.strings.aurora_greeting_manga_double_spread),
        candidate("manga_no_color", AYMR.strings.aurora_greeting_manga_no_color),
        candidate("manga_webtoon_scroll", AYMR.strings.aurora_greeting_manga_webtoon_scroll),
        candidate("manga_cliffhanger_pain", AYMR.strings.aurora_greeting_manga_cliffhanger_pain),
        candidate("manga_update_refresh", AYMR.strings.aurora_greeting_manga_update_refresh),
        candidate("manga_art_style", AYMR.strings.aurora_greeting_manga_art_style),
        candidate("manga_raws", AYMR.strings.aurora_greeting_manga_raws),
        candidate("manga_scanlation", AYMR.strings.aurora_greeting_manga_scanlation),
        candidate("novel_long_title", AYMR.strings.aurora_greeting_novel_long_title),
        candidate("novel_imagination", AYMR.strings.aurora_greeting_novel_imagination),
        candidate("novel_one_volume", AYMR.strings.aurora_greeting_novel_one_volume),
        candidate("novel_mtl", AYMR.strings.aurora_greeting_novel_mtl),
        candidate("novel_wall_of_text_2", AYMR.strings.aurora_greeting_novel_wall_of_text_2),
        candidate("novel_illustration", AYMR.strings.aurora_greeting_novel_illustration),
        candidate("novel_cultivation_stage", AYMR.strings.aurora_greeting_novel_cultivation_stage),
        candidate("trope_system_quest", AYMR.strings.aurora_greeting_trope_system_quest),
        candidate("trope_villainess", AYMR.strings.aurora_greeting_trope_villainess),
        candidate("trope_murim", AYMR.strings.aurora_greeting_trope_murim),
        candidate("trope_hidden_power", AYMR.strings.aurora_greeting_trope_hidden_power),
        candidate("trope_regression", AYMR.strings.aurora_greeting_trope_regression),
        candidate("trope_op_mc", AYMR.strings.aurora_greeting_trope_op_mc),
        candidate("trope_dense_mc", AYMR.strings.aurora_greeting_trope_dense_mc),
        candidate("trope_revenge", AYMR.strings.aurora_greeting_trope_revenge),
        candidate("general_3d_wait", AYMR.strings.aurora_greeting_general_3d_wait),
        candidate("general_comfort_zone", AYMR.strings.aurora_greeting_general_comfort_zone),
        candidate("general_serotonin", AYMR.strings.aurora_greeting_general_serotonin),
        candidate("general_do_not_disturb", AYMR.strings.aurora_greeting_general_do_not_disturb),
        candidate("general_salary", AYMR.strings.aurora_greeting_general_salary),
        candidate("general_warm_soul", AYMR.strings.aurora_greeting_general_warm_soul),
        candidate("general_no_deadlines", AYMR.strings.aurora_greeting_general_no_deadlines),
        candidate("general_escapism_sponsored", AYMR.strings.aurora_greeting_general_escapism_sponsored),
        candidate("general_thousand_worlds", AYMR.strings.aurora_greeting_general_thousand_worlds),
        candidate("general_tea_ready", AYMR.strings.aurora_greeting_general_tea_ready),
        candidate("general_cat_sleeps", AYMR.strings.aurora_greeting_general_cat_sleeps),
        candidate("habit_just_one_chapter", AYMR.strings.aurora_greeting_habit_just_one_chapter),
        candidate("habit_backlog_crying", AYMR.strings.aurora_greeting_habit_backlog_crying),
        candidate("habit_bookmarks", AYMR.strings.aurora_greeting_habit_bookmarks),
        candidate("habit_memory_wipe", AYMR.strings.aurora_greeting_habit_memory_wipe),
        candidate("habit_new_tab", AYMR.strings.aurora_greeting_habit_new_tab),
        candidate("habit_chapter_hoarder", AYMR.strings.aurora_greeting_habit_chapter_hoarder),
        candidate("ui_screen_clean", AYMR.strings.aurora_greeting_ui_screen_clean),
        candidate("ui_battery_check", AYMR.strings.aurora_greeting_ui_battery_check),
        candidate("ui_brightness", AYMR.strings.aurora_greeting_ui_brightness),
        candidate("ui_wifi_blessing", AYMR.strings.aurora_greeting_ui_wifi_blessing),
        candidate("ui_update_check", AYMR.strings.aurora_greeting_ui_update_check),
        candidate("ui_dark_mode", AYMR.strings.aurora_greeting_ui_dark_mode),
        candidate("ui_haptic", AYMR.strings.aurora_greeting_ui_haptic),
        candidate("ui_welcome_master", AYMR.strings.aurora_greeting_ui_welcome_master),
    )
