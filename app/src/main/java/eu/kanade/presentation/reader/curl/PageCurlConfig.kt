 ...
 * is visible) to 1 (everything is visible). Ignored when [independentBackPageEnabled] is true.
 * @param independentBackPageEnabled When true, the back of the curling flap renders the neighbouring page's own
 * content (supplied per-page by the caller) instead of a mirrored, tinted copy of the current page.
...
public fun rememberPageCurlConfig(
    ...
    independentBackPageEnabled: Boolean = false,
    ...
    rememberSaveable(
        ...
        PageCurlConfig(
            ...
            independentBackPageEnabled = independentBackPageEnabled,
...
public class PageCurlConfig(
    ...
    independentBackPageEnabled: Boolean,
    shadowColor: Color,
    shadowAlpha: Float,
    shadowRadius: Dp,
     ...
     * 1 (everything is visible). Ignored when [independentBackPageEnabled] is true.
     */
    public var backPageContentAlpha: Float by mutableStateOf(backPageContentAlpha)

    /**
     * When true, the back of the curling flap renders the neighbouring page's own content (supplied per-page by
     * the caller) instead of a mirrored, tinted copy of the current page.
     */
    public var independentBackPageEnabled: Boolean by mutableStateOf(independentBackPageEnabled)
